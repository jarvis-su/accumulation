...
package com.jarvis.basic.supporter.kit;

import com.jarvis.basic.supporter.logger.BasicLog;

public class LogKit {

	private static class Holder {
		private static BasicLog log = BasicLog.getLog(LogKit.class);
	}
	...
	public static void synchronizeLog() {
		Holder.log = BasicLog.getLog(LogKit.class);
	}
